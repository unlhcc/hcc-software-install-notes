...
PREFIX=/util/opt/netcdf/4.7.4/gcc/9.1.0
module purge
module load compiler/gcc/9.1 hdf5/1.12
# the netCDF build process doesn't seem to include the rpath
# for zlib by default
export NCDIR=/util/opt/netcdf/4.7/gcc/9.1
export LDFLAGS="${LDFLAGS} -Wl,-rpath=/util/opt/zlib/1.2/gcc/9.1/lib -L$NCDIR/lib" 
