...
COMPILER=pgi
COMPILER_VERSION=15.10

module load compiler/pgi/15 netcdf/4.4 szip/2.1  zlib/1.2
...
./configure --disable-openmp --prefix=/util/opt/${PACKAGE}/${PACKAGE_VERSION}/${COMPILER}/${COMPILER_VERSION} --enable-largefile --disable-ncap2 --disable-udunits --enable-udunits2 --enable-netcdf4
