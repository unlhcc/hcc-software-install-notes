...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/util/opt/hdf5/1.8/intel/18/lib
export LDFLAGS='-L/util/opt/hdf5/1.8/intel/18/lib -L/util/opt/szip/2.1/intel/18/lib -L/util/opt/zlib/1.2/intel/18/lib'

./configure --prefix=/util/opt/netcdf/4.4/intel/18.0.1 --enable-largefile --enable-netcdf4
