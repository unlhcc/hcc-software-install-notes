...
rm -f makefile.include && cp makefile.include.intel_ompi_mkl_omp_avx2_sol makefile.include
make veryclean
make DEPS=1 -j 4 all

# mkdir -p /util/opt/vasp/6.4.1-sol/intel/20/openmpi/4.1/bin/
# cp bin/* /util/opt/vasp/6.4.1-sol/intel/20/openmpi/4.1/bin/
