...
module purge
module load compiler/intel/20 openmpi/4.0 intel-mkl/20 hdf5/1.12 wannier90/3.1 libbeef/0.1 libxc/5.1 dftd4/3.3
...
rm -f makefile.include && cp makefile.include.intel_ompi_mkl_omp_vtst makefile.include
make veryclean
make DEPS=1 -j 4 all
