...
IFLAGS="-I../include -I${MKLROOT}/include -I${MKLROOT}/include/fftw -I/util/src/espresso/qe-6.6/include" \
MOD_FLAG="/util/src/espresso/qe-6.6/include" #this needs to point to the include directory in the topdir
