...
module load compiler/intel/2021 intel-mkl/20 openmpi/4.1
#module load compiler/intel/19 intel-mkl/19 openmpi/4.0
# MKL module defines MKLROOT

PREFIX=/util/opt/espresso/7.1/openmpi/4.1/intel/2021
...
IFLAGS="-I../include -I${MKLROOT}/include -I${MKLROOT}/include/fftw -I/util/src/espresso/q-e-qe-7.1/include" \
MOD_FLAG="/util/src/espresso/q-e-qe-7.1/include" #this needs to point to the include directory in the topdir
