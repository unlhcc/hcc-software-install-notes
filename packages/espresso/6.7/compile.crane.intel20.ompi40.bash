...
PREFIX=/util/opt/espresso/6.7/openmpi/4.0/intel/20.0
...
IFLAGS="-I../include -I${MKLROOT}/include -I${MKLROOT}/include/fftw -I/util/src/espresso/qe-6.7/include" \
MOD_FLAG="/util/src/espresso/qe-6.7/include" #this needs to point to the include directory in the topdir
