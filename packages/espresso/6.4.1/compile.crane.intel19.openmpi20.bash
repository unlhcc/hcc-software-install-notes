...
module load compiler/intel/19 intel-mkl/19 openmpi/2.0
# MKL module defines MKLROOT

PREFIX=/util/opt/espresso/6.4.1/openmpi/2.0.2/intel/19.0.1
...
MOD_FLAG="/util/src/quantum-espresso/qe-6.4.1/include" #this needs to point to the include directory in the topdir
