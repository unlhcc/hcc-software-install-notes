...
module purge
module load compiler/gcc/11 cuda/11.8 intel-mkl/20 gstreamer/1.22 cmake python/3.10 java/19
PYTHON=$(which python)
PREFIX=/util/opt/opencv/4.8.1/gcc/11
...
cmake -DCMAKE_INSTALL_PREFIX=${PREFIX} \
   ...
   -DWITH_VTK=OFF -DWITH_VA=OFF \
   -DOPENCV_EXTRA_MODULES_PATH=/util/src/opencv/opencv_contrib-4.8.1/modules \
