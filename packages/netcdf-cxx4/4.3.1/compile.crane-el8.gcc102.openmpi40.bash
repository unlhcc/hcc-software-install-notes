...
PREFIX=/util/opt/netcdf/4.7.4/openmpi/4.0.5/gcc/10.2.0
module purge
module load compiler/gcc/10.2 openmpi/4.0 phdf5/1.12
# the netCDF build process doesn't seem to include the rpath
# for zlib by default
export NCDIR=/util/opt/netcdf/4.7/openmpi/4.0/gcc/10.2
