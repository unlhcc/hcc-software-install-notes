...
module load compiler/intel/16 intel-mkl/16 openmpi/2.0 fftw3/3.3

make clean && make distclean
unset F77 F90 CFLAGS CXXFLAGS FCFLAGS FFLAGS F90FLAGS

./configure --prefix=/util/opt/petsc/3.10.5/openmpi/2.0/intel/16.0.3 \
--download-hypre=1 \
--with-fftw=1 \
--with-fftw-dir="/util/opt/fftw3/3.3/openmpi/2.0/intel/16" \
--with-ssl=0 \
--with-debugging=no \
--with-pic=1 \
